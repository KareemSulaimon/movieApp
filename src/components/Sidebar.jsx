...
function Sidebar() {
  return (
    <div className="flex flex-col w-full sm:w-[200px] sm:justify-between
     sm:h-[600px] bg-white border-r border-t-r  border-solid border-red-200 mb-4 rounded-t-2xl gap-4 items-center sm:items-start">
